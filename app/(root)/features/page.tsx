...
const FeaturesPage = () => {
  return (
    <div>
        ...
        <h1 className="text-white font-bold text-4xl lg:text-6xl max-w-5xl lg:leading-20 text-center">Comprehensive Features for Modern Security</h1>
        <p className="text-white font-medium text-xl text-center max-w-3xl">TEK1SECURITY provides a robust suite of tools designed to streamline every aspect of your security operations, ensuring efficiency, accountability, and enhanced client satisfaction.</p>
      </section>

      {/* Features Section */}
      <section className="flex w-full flex-col items-center gap-12 py-20 px-10 md:px-20 lg:px-40">
        <div className="text-center space-y-4 max-w-3xl">
          <h2 className="font-bold text-3xl md:text-5xl">Our Powerful Features</h2>
          <p className="text-lg">Discover how TEK1SECURITY can transform your security company's operations.</p>
        </div>
