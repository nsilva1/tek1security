    ...
    <div className="flex flex-col min-h-screen">
        {/* Section 1: Hero Section */}
            <section className="flex w-full flex-col items-center gap-8 bg-secondary py-20 px-10 md:px-20 lg:px-40">
                ...
                <p className="text-white font-medium text-lg text-center max-w-3xl">
                   Don't just take our word for it. Hear directly from security companies across Nigeria who have experienced significant growth and efficiency with TEK1SECURITY.
                </p>
            </section>
            ...
            <section className="flex w-full flex-col items-center gap-12 py-20 px-10 md:px-20 lg:px-40 bg-white">
                <div className="text-center space-y-4 max-w-3xl">
                    <h2 className="font-bold text-3xl md:text-5xl">Real Stories, Real Results</h2>
                    <p className="text-lg text-muted-foreground">Our clients' success is our greatest achievement. Here are some of their experiences.</p>
                </div>
            ...
            return (
              <Card key={index} className="bg-background flex flex-col border-l-4 border-l-primary hover:shadow-2xl transition-all duration-300">
                ...
                <CardFooter className="flex gap-2">
                  <CardDescription className="text-sm md:text-base text-secondary font-bold">{testimonial.name},</CardDescription>
                  <CardDescription className="text-sm md:text-base text-secondary font-bold">{testimonial.role}</CardDescription>
                </CardFooter>
              </Card>
            );
          })}
      ...
      <section className="flex w-full flex-col items-center gap-12 py-20 px-10 md:px-20 lg:px-40 bg-secondary">
        <div className="text-center space-y-4 max-w-6xl">
          <h2 className="font-bold text-3xl md:text-5xl text-white">Ready to Become Our Next Success Story?</h2>
          <p className="text-lg text-white">Join the growing number of security companies in Nigeria who are thriving with TEK1SECURITY.</p>
        </div>
