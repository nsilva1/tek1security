    ...
    <div>
      ...
      <section className="flex w-full flex-col items-center gap-8 bg-secondary py-20 px-10 md:px-20 lg:px-40">
        <h1 className="text-white font-bold text-4xl lg:text-6xl max-w-5xl lg:leading-20 text-center">
          TEK1SECURITY: Modern Security
          <br />
          Management Solutions for Nigeria
        </h1>
        <p className="text-white font-medium text-xl text-center max-w-3xl">
          Empower your security operations in Lagos, and across Nigeria. Our
          intuitive platform streamlines guard management, incident reporting,
          payroll, and client communication, ensuring efficiency and
          accountability.
        </p>
      ...
      <section className="flex w-full flex-col items-center gap-12 bg-zinc-50 dark:bg-zinc-950 py-20 px-10 md:px-20 lg:px-40">
        <div className="text-center space-y-4 max-w-3xl">
          <h2 className="font-bold text-3xl md:text-5xl text-foreground">
            Why Choose Tek1Security?
          </h2>
          <p className="text-muted-foreground">
            Discover the unique advantages of our platform designed specifically
            for the Nigerian security landscape.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-7xl">
          {why_tek1.map((item, index) => {
            ...
            return (
              <Card
                key={index}
                className="border-border/50 bg-background hover:shadow-lg transition-all duration-300"
              >
                <CardHeader>
      ...
      <section className="flex w-full flex-col items-center gap-12 py-20 px-10 md:px-20 lg:px-40 bg-secondary">
        <div className="text-center space-y-4 max-w-3xl">
          ...
          <p className="text-lg text-white">
            TEK1SECURITY offers a robust suite of tools designed for security
      ...
      <section className="flex w-full flex-col items-start gap-12 py-20 px-10 md:px-20 lg:px-40 bg-zinc-50 dark:bg-zinc-950">
        <div className="text-start space-y-4">
          <h2 className="font-bold text-3xl md:text-5xl text-primary">
            Built for Security Excellence in Nigeria
          </h2>
          <p className="text-lg">
            TEK1SECURITY, developed by TEKNNUKU Inc. in Lagos, Nigeria, is
            specifically engineered to address the unique challenges and
            opportunities of the Nigerian security industry. We understand the
            local context and have tailored our platform to enhance efficiency,
            accountability, and communication for security companies operating
            across the nation.
          </p>
          <p className="text-lg">
            Our mission is to empower security firms, enabling them to provide
            superior service, manage their workforce effectively, and drive
            growth with a cutting-edge security management solution.
          </p>
        </div>
      </section>
            ...
            return (
              ...
              >
                ...
                <CardFooter className="flex">
                  <CardDescription className="text-base text-secondary font-bold">
                    {testimonial.name}
                  </CardDescription>
                  <CardDescription className="text-base text-secondary font-bold">
                    {testimonial.role}
      ...
      <section className="flex w-full flex-col items-center gap-12 py-20 px-10 md:px-20 lg:px-40 bg-zinc-50 dark:bg-zinc-950">
        <div className="text-center space-y-4 max-w-3xl">
          ...
          <p className="text-lg text-muted-foreground">
            Find answers to common questions about TEK1SECURITY.
          </p>
        </div>
              ...
              <CardContent>
                <form className="flex flex-col gap-6">
                  ...
                  <Button
                    type="submit"
                    size="lg"
                    className="w-full md:w-auto bg-primary text-white mt-2"
                  >
                    Send Message
                  </Button>
                </form>
